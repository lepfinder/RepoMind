export const PROSE_CLS = `prose prose-sm dark:prose-invert max-w-none
  ...
  [&_code]:bg-gray-100 dark:[&_code]:bg-gray-800 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-[11px] [&_code]:font-mono [&_code]:text-gray-900 dark:[&_code]:text-gray-100
